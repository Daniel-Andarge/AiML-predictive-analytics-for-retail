"""AiML-predictive-analytics-for-retail file for ensuring the package is executable
as `aiml-predictive-analytics-for-retail` and `python -m aiml_predictive_analytics_for_retail`
"""
import importlib
